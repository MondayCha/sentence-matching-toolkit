...
const NoFile = (
  ...
  <svg viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
      d="m102.958 162.245 94.388-43.571 94.286 43.571-94.286 23.776-94.388-23.776Z"
      fill="#202020"
      stroke="#202020"
      strokeWidth={0.87}
      strokeMiterlimit={10}
    ...
    />
    <path
      d="M244.798 52.55h-5.204v5.205h5.204V52.55Zm41.834 2.145h-39.081v1.02h39.081v-1.02Zm4.491.001h-1.02v1.02h1.02v-1.02Zm31.122 1.019h-1.939v-1.02h1.939v1.02Zm-7.755 0h-1.939v-1.02h1.939v1.02Zm-7.858 0h-1.938v-1.02h1.938v1.02Zm-7.755 0h-1.939v-1.02h1.939v1.02Zm30.202-1.02h-1.02v1.02h1.02v-1.02Zm3.269 5.306-.51-.816 6.224-3.776-6.224-4.081.612-.919 7.551 5-7.653 4.592Z"
      fill="#202020"
    />
    <path
      d="m281.428 44.898 7.551-9.183M275.714 20l-13.163 26.53M125.716 71.938l19.898 25m4.589-59.693 15.102 36.122"
      stroke="#DEDFEA"
      strokeWidth={0.87}
      strokeMiterlimit={10}
    />
    ...
    />
    <path
      d="M292.041 115.817c5.918 0 10.714-4.796 10.714-10.714"
      stroke="#202020"
      strokeWidth={0.87}
      strokeMiterlimit={10}
      strokeLinecap="round"
    ...
    />
    <path
      d="m297.552 132.653-3.061-1.734-7.245 13.367 10.306-11.633Z"
      fill="#202020"
      stroke="#202020"
      strokeWidth={0.87}
      strokeMiterlimit={10}
    ...
    />
    <path
      d="M102.859 115.817c-5.919 0-10.715-4.796-10.715-10.715"
      stroke="#202020"
      strokeWidth={0.87}
      strokeMiterlimit={10}
      strokeLinecap="round"
    ...
    />
    <path
      d="m97.347 132.653 3.061-1.735 7.143 13.368-10.204-11.633Z"
      fill="#202020"
      stroke="#202020"
      strokeWidth={0.87}
      strokeMiterlimit={10}
    ...
    />
    <path
      d="M102.958 162.246v90.306l94.388 27.551v-94.082l-94.388-23.775Zm188.775 0v90.306l-94.387 27.551v-94.082l94.387-23.775Z"
      fill="#c3c6e1"
      stroke="#202020"
      strokeWidth={0.87}
      strokeMiterlimit={10}
    />
    <path
      d="m103.469 170.715.102 45.306 55.306 15.918 38.469-45.918-93.877-15.306Zm187.961 0v45.306l-55.306 15.918-38.47-45.918 93.776-15.306Z"
      fill="#202020"
      stroke="#202020"
      strokeWidth={0.87}
      strokeMiterlimit={10}
    ...
    />
    <path
      d="m292.042 162.246 45 34.183-99.694 27.449-39.796-37.857 94.49-23.775Zm-189.083 0L60 195.001l97.551 28.877 39.796-37.857-94.388-23.775Z"
      fill="#DEDFEA"
      stroke="#202020"
      strokeWidth={0.87}
      strokeMiterlimit={10}
