...
const InfoFilled = (
  ...
  >
    ...
    <path
      ...
      fill={props.theme == 'dark' ? SVG_FILLED_BACKGROUND.DARK : SVG_FILLED_BACKGROUND.LIGHT}
    />
    <path
      d="M24.5 34V20h-2M21 34h7"
      stroke={props.theme == 'dark' ? SVG_FILLED_BACKGROUND.DARK : SVG_FILLED_BACKGROUND.LIGHT}
      strokeWidth={4}
      strokeLinecap="round"
      strokeLinejoin="round"
    />
